...
import ChantierPDFDocument from '../components/PDFPreview';
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
          ...
          >
            ...
            {showPdfPreview ? 'Cacher PDF' : 'Aperçu PDF'}
          </button>

          <PDFDownloadLink
            document={<ChantierPDFDocument chantier={chantier} interventions={interventions} />}
            fileName={`chantier-${chantier._id}.pdf`}
